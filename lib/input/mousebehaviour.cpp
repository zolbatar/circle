...
#define W 0xFF2F2F2FU
    {G, G, B, B, B, B, B, B, B, B, B, B, B, B, B, B}, {G, W, G, B, B, B, B, B, B, B, B, B, B, B, B, B},
    {G, W, W, G, B, B, B, B, B, B, B, B, B, B, B, B}, {G, W, W, W, G, B, B, B, B, B, B, B, B, B, B, B},
    {G, W, W, W, W, G, B, B, B, B, B, B, B, B, B, B}, {G, W, W, W, W, W, G, B, B, B, B, B, B, B, B, B},
    {G, W, W, W, W, W, W, G, B, B, B, B, B, B, B, B}, {G, W, W, W, W, W, W, W, G, B, B, B, B, B, B, B},
    {G, W, W, W, W, W, W, W, W, G, B, B, B, B, B, B}, {G, G, G, G, W, W, G, G, G, G, G, B, B, B, B, B},
    {B, B, B, G, W, W, W, G, B, B, B, B, B, B, B, B}, {B, B, B, B, G, W, W, G, B, B, B, B, B, B, B, B},
    {B, B, B, B, G, W, W, W, G, B, B, B, B, B, B, B}, {B, B, B, B, B, G, W, W, G, B, B, B, B, B, B, B},
    {B, B, B, B, B, G, W, W, W, G, B, B, B, B, B, B}, {B, B, B, B, B, B, G, G, G, G, B, B, B, B, B, B}};

CMouseBehaviour::CMouseBehaviour(void)
    : m_nScreenWidth(0), m_nScreenHeight(0), m_nPosX(0), m_nPosY(0), m_bHasMoved(FALSE), m_bCursorOn(FALSE),
      m_nButtons(0), m_pEventHandler(0)
{
}
...
boolean CMouseBehaviour::SetCursor(unsigned nPosX, unsigned nPosY)
{
    assert(m_nScreenWidth > 0);
    assert(m_nScreenHeight > 0);
    if (nPosX >= m_nScreenWidth || nPosY >= m_nScreenHeight)
    {
        return FALSE;
    }
...
void CMouseBehaviour::MouseStatusChanged(unsigned nButtons, int nDisplacementX, int nDisplacementY, int nWheelMove)
{
    ...
    if (m_nPosX != nPrevX || m_nPosY != nPrevY)
    {
        m_bHasMoved = TRUE;
